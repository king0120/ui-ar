...
import { Avatar, List, ListItemAvatar, ListItem, ListItemText, Tabs, Tab } from '@material-ui/core';
...
const TalentList: FC<ITalentList> = ({ talent = [] }) => {
    ...
    return (
        <div>
            <Tabs value={value} onChange={(e, newValue) => { setValue(newValue) }} aria-label="simple tabs example">
                    ...
                    {confirmed.map((actor) => {
                        return (
                            <ListItem key={actor.id}>
                                <ListItemAvatar>
                                    <Avatar src={actor.user.profilePicture && actor.user.profilePicture.url} />
                                </ListItemAvatar>
                                <ListItemText
                                    primary={actor.user.displayName}
                                />
                            </ListItem>
                        )
                    })}
