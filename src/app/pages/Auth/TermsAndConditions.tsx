...
export default function TermsAndConditions(props: any) {
    ...
    return (
        <Dialog onClose={handleClose} aria-labelledby="terms-and-conditions" open={open}>
            ...
            <DialogTitle>Terms of Service ("Terms") <small>Updated: Feb 14, 2020</small></DialogTitle>
            <DialogContent>
                <p>Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the
                    http://www.auditionrevolution.com website and the Audition Revolution mobile application (the
                    "Service") operated by Audition Revolution LLC ("us", "we", or "our").</p>
                ...
                <br/>
                <h3>Subscriptions</h3>
                <p>Some parts of the Service are billed on a subscription basis ("Subscription(s)"). You will be billed
                    in advance on a recurring monthly or annual basis.</p>

                <br/>
                <h3>Content</h3>
                <p>Our Service allows you to post, link, store, share and otherwise make available certain information,
                    text, graphics, videos, or other material ("Content"). You are responsible for the content shared on
                    our site. Any violations – either legal or ethical – are your responsibility and not the
                    responsibility of Audition Revolution.</p>

                <br/>
                <h3>Links To Other Web Sites</h3>
                <p>Our Service may contain links to third-party web sites or services that are not owned or controlled
                    by Audition Revolution.</p>

                <p>Audition Revolution has no control over, and assumes no responsibility for, the content, privacy
                    policies, or practices of any third party web sites or services. You further acknowledge and agree
                    that Audition Revolution shall not be responsible or liable, directly or indirectly, for any damage
                ...
                <br/>
                <h3>Contact Us</h3>
                <p>If you have any questions about these Terms, please contact us at support@auditionrevolution.com.</p>
            </DialogContent>
