                    ...
                    {audition.timeSlots.map((timeslot: any) => {
                        return (
                            <Paper key={timeslot.id} className={"m-8 p-8"}>
                                <div className={'flex'}>
                                    <p className={"mr-8"}>Start Time: {format(new Date(timeslot.startTime), "hh:mm aa")}</p>
                                    <p>End Time: {format(new Date(timeslot.endTime), "hh:mm aa")}</p>
                                </div>

                                <p>Capacity: {timeslot.capacity} ({timeslot.capacity - timeslot.talent.length} Slots Available )</p>
                                <div className={'mt-16'}>
